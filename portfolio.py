...
class Portfolio(object):
    ...
    """
    #Bars is yielding data bar generated by DataHandler
    def __init__(self, bars, events, start_date, initial_capital = 100000.0):
        ...
        Datas Structure:
            ...
            self.all_positions/holdings: [{dic1}, {dic2}.....]
            dic1,dic2 in time-step，每个hash里有每个股票在这个time step
            的情况

            all_positions：quantity of symbols
    ...
    def construct_all_holdings(self):
        ...
        #Cash: spare cash in the account after any purchases
        d['cash'] = self.initial_capital
        d['commission'] = 0.0

        #d["total"]: "total" portfolio value.
    ...
    def update_timeindex(self, event):
        ...
        ####算手上的股票值多少钱，存在all holdings这个var
        for s in self.symbol_list:
    ...
    def update_holdings_from_fill(self, fill):
        ...
        ### Dumb Assumption:
        ### fill.quantity is a fixed number
